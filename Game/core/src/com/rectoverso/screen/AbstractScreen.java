...
public abstract class AbstractScreen implements Screen{
	...
	public AbstractScreen(RVGame game ){
		this.game = game;
	...
	public void resize(int width, int height) {
		// TODO Auto-generated method stub
		 Gdx.app.log( RVGame.LOG, "Resizing screen: " + getName() + " to: " + width + " x " + height );
	}

	@Override
	public void show() {
		// TODO Auto-generated method stub
		Gdx.app.log( RVGame.LOG, "Showing screen: " + getName());
	...
	public void hide() {
		// TODO Auto-generated method stub
		Gdx.app.log( RVGame.LOG, "Hiding screen: " + getName());
	...
	public void pause() {
		// TODO Auto-generated method stub
		Gdx.app.log( RVGame.LOG, "Pausing screen: " + getName());
	}

	@Override
	public void resume() {
		// TODO Auto-generated method stub
		Gdx.app.log( RVGame.LOG, "Resuming screen: " + getName());
	}

	@Override
	public void dispose() {
		// TODO Auto-generated method stub
		Gdx.app.log( RVGame.LOG, "Disposing screen: " + getName());
