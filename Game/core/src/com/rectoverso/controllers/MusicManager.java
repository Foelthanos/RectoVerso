        ...
        Disposable
{
     ...
     */
    private RVMusic musicBeingPlayed;
        ...
        RVMusic music )
    {
        ...
        // do some logging
        Gdx.app.log( RVGame.LOG, "Playing music: " + music.name() );
    ...
    public void stop()
    {
        if( musicBeingPlayed != null ) {
            Gdx.app.log( RVGame.LOG, "Stopping current music" );
    ...
    public void setVolume(
        float volume )
    {
        Gdx.app.log( RVGame.LOG, "Adjusting music volume to: " + volume );
    ...
    public void dispose()
    {
        Gdx.app.log( RVGame.LOG, "Disposing music manager" );
        stop();
    }
}